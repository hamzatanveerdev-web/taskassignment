...
export default function Header({ onMenuClick }) {
  ...
  return (
 <motion.header
  className="sticky top-0 h-14 z-10 bg-white/95 backdrop-blur-md border-b border-gray-200 transition-all duration-300"
...
>
  <div className="flex items-center justify-between px-4 md:px-6 h-full">
    ...
    {/* Center section - Empty or can add something */}
