...
export default function EmployeeDashboardPage() {
  ...
  return (
    <>
      <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6 md:mb-8">My Dashboard</h1>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="card">
        <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-4">Today's Tasks</h2>
